...
<div style="padding:30px;text-align:center;">
    <h1>«<?=$projectName?>»</h1>
    <? $files = scandir($_SERVER["DOCUMENT_ROOT"] . '/h/'); ?>
    <div class="table-parent">
        <table cellpadding="0" cellspacing="1" class="table">
                ...
                <td>
                    <a class="link" target="_blank" href="<?=$prototypeLink?>">
                        ...
                        <div class="link-preview">
                            <iframe style="background:#fff;border:0;width:1280px;height:2000px;transform:scale(.2);transform-origin:0 0;" src="<?=$prototypeLink?>"></iframe>
                        </div>
                    </a>
                </td>
            </tr>
            ...
            <? foreach($files as $key=>$value): ?>
                ...
                <tr>
                    <td>
                        <a class="link" target="_blank" href="/h/<?=$value?>">
                            <?=$c?>. <?=$value?>
                            <div class="link-preview">
                                <iframe style="background:#fff;border:0;width:1280px;height:2000px;transform:scale(.2);transform-origin:0 0;" src="/h/<?=$value?>"></iframe>
                            </div>
                        </a>
                    </td>
                </tr>
